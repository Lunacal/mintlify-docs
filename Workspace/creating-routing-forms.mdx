...
## Routing at Team Level – How It Works
...
Disabling a form stops it from accepting new submissions but preserves past responses.
...
- Routing to members who are hidden from booking page\
- Forgetting to assign event types to routed members\
- Not testing all rule combinations\
- Overcomplicating logic with too many conditional branches
...
If you want next-level documentation, we can add:

- A visual routing flow example
- A decision-tree diagram
- Real-world service business example (agency / SaaS sales team)
