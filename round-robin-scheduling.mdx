...
Use "[Collective Scheduling](https://help.lunacal.ai/collective-schedule)" when the meeting must include multiple hosts (e.g., panel interview, complex demo with SE).
