...
In the "**Event Setup**" section, scroll down to find "**Package Booking**" With Title "**Create a Multi-Session Package**" & **Toggle ON**.
...
> For example i chose Flexible Range 2-6, Now attendee can book **2, 3, 4, 5, or 6 sessions**
