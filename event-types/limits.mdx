...
When limits such as Advance Booking Limit or Advance Notice are updated, the changes apply only to new bookings. Existing bookings remain unaffected. Example: Show only the next 30 days so your calendar doesn’t get locked months ahead. 💡
