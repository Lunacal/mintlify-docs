...
In “Limits and Buffer”, set a buffer before and after meetings. You can choose up to 120 minutes for both before and after buffers.\
...
In the advance booking notice section, define the minimum lead time before someone can book you. This prevents last-minute bookings (for example, within the next hour). You can set the notice in minutes, hours, or days.\
...
Limit booking frequency to control how many times someone can book you within a period. You can restrict to one booking per day, week, month, or year, and you can add multiple limits (up to 4) for an event.\
...
• Setting buffers but leaving the advance booking notice at “0”, allowing last-minute bookings anyway.\
...
• Advance booking notice: 2 hours (same-day safety net).\
