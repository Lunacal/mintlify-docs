...
description: "Use “Workflows” to automate notifications for your personal events & team events - set a trigger, pick recipients, and send a template. Keep steps the same; only fill in names, timing, and recipients."
mode: "wide"
---
