...
**Do I need to remember a password?** No. You sign in either through your email link or with a one-time 6-digit code.

**My link stopped working.** Access links expire after 7 days. Just go to the portal, enter your email, and sign in with the one-time code we send you.

**I'm not getting the code email.** Check your spam folder, confirm you entered the same email your organizer used to book you, and request the code again.